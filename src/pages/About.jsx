    ...
    <div>
      ...
      <div className="flex flex-col gap-16 my-10 md:flex-row">
        ...
        <div className="flex flex-col justify-center gap-6 text-gray-600 md:w-2/4">
          <p>
            Welcome to AnondoShop, where style meets quality. Our mission is to
          ...
          <p>
            At AnondoShop, we prioritize your satisfaction. From the moment you
            ...
            choosing AnondoShop. We’re excited to be a part of your style journey.
          </p>
          <b className="text-gray-800">Our Mission</b>
          <p>
            At AnondoShop, our mission is to empower you to express your unique
          ...
          <p>
            At AnondoShop, our vision is to be a global fashion leader, known for
            cutting-edge style and quality. We aim to inspire confidence and
            creativity, making AnondoShop the go-to choice for individual
            expression.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col mb-20 text-sm md:flex-row">
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600">
            At AnondoShop, quality comes first. Every product is carefully chosen
        ...
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          <b>Convenience</b>
          <p className="text-gray-600">
            AnondoShop ensures a smooth shopping experience with easy browsing,

...
const Profile = () => {
  ...
  const canonicalUrl = `${SITE_URL}/profile`;
  ...
  return (
    <>
      <Helmet>
        <title>My Profile | AnondoShop</title>
        <meta
          name="description"
          content="Manage your AnondoShop profile and delivery address. Update your name and shipping details for faster checkout in Bangladesh."
        />
        ...
        <meta property="og:title" content="My Profile | AnondoShop" />
        <meta
          property="og:description"
          content="View and update your AnondoShop account information and delivery address used for your orders."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="My Profile | AnondoShop" />
        <meta
          name="twitter:description"
          content="Edit your AnondoShop profile details and Bangladesh delivery address for a smoother shopping experience."
        />
        <meta
          name="twitter:image"
          content="https://cdn-icons-png.flaticon.com/512/625/625149.png"

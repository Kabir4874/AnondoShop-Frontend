...
const Orders = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Your Orders | AnondoShop</title>
        <meta
          name="description"
          content="View and track your AnondoShop orders. Check current status, delivery progress and item details for every order in one place."
        />
        ...
        <meta property="og:title" content="Your Orders | AnondoShop" />
        <meta
          property="og:description"
          content="Track your AnondoShop orders in real-time, see delivery steps, ETA and shipping details for each purchase."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Your Orders | AnondoShop" />
        <meta
          name="twitter:description"
          content="Manage and track all your AnondoShop orders, from order placed to delivered, with detailed status updates."
        />
        <meta
          name="twitter:image"
          content="https://cdn-icons-png.flaticon.com/512/625/625149.png"
                        ...
                        <div
                          ...
                          style={{
                            width: `${Math.min(
                              ...
                              Math.max(
                                0,
                                trackOrder?.progress?.progressPct || 0
                              )
                            )}%`,
                          }}
                        />
                    ...
                    <section>
                      ...
                      <div className="space-y-3">
                        {(trackOrder?.items || []).map((it, i) => {
                          ...
                          const sub =
                            Number(it?.lineSubtotal ?? unit * qty) || 0;
